...
import io.github.posaydone.filmix.presentation.ui.homeScreen.HomeScreenUiState
import io.github.posaydone.filmix.presentation.ui.homeScreen.HomeScreenViewModel
import io.github.posaydone.filmix.presentation.utils.Padding
    ...
    when (val s = uiState) {
        ...
        is HomeScreenUiState.Done -> {
            Body(
                ...
                goToDetails = { showId ->
                    navController.navigate(MobileScreens.Main.Details(showId)) {
