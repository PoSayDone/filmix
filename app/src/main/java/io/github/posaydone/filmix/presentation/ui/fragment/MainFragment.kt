...
import io.github.posaydone.filmix.presentation.ui.adapter.CategoriesPagerAdapter
import io.github.posaydone.filmix.presentation.ui.viewModel.CategoriesViewModel
import io.github.posaydone.filmix.presentation.ui.viewModel.CategoriesViewModelFactory
...
class MainFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModelFactory = CategoriesViewModelFactory(filmixRepository)
        viewModel =
            ViewModelProvider(
                requireActivity(),
                viewModelFactory
